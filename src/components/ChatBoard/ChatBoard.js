...
export default class ChatBoard extends Component {
  constructor(props) {
    ...
    this.currentUserId = localStorage.getItem(constants.ID);
    this.currentUserAvatar = localStorage.getItem(constants.PHOTO_URL);
    this.currentUserNickname = localStorage.getItem(constants.NICKNAME);
    this.listMessage = [];
  ...
  getListHistory = () => {
    ...
    this.removeListener = appFirestore
      .collection(constants.NODE_MESSAGES)
      .doc(this.groupChatId)
      .collection(this.groupChatId)
      .onSnapshot(
        snapshot => {
          snapshot.docChanges().forEach(change => {
            if (change.type === constants.DOC_ADDED) {
